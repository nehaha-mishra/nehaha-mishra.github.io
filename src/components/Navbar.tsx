  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden glass fixed inset-0 top-16 p-4 bg-white/90 backdrop-blur-md shadow-lg">
            <div className="flex flex-col space-y-6 pt-8 items-center">
              ...
              <a 
                href="#contact" 
                className="text-lg font-medium text-white bg-neha-600 hover:bg-neha-700 px-6 py-2 rounded-full shadow-md transition-all"
                onClick={() => setIsMenuOpen(false)}
              >
                Contact
              </a>
