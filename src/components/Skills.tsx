  ...
  return (
    <section id="skills" className="py-12 sm:py-16 md:py-24 bg-neha-50/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
          {skillsData.map((skill, index) => (
            <motion.div 
              ...
              className="skill-card glass p-4 sm:p-6 rounded-2xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-neha-100/50"
            >
              ...
              <div className="h-2.5 bg-neha-100 rounded-full overflow-hidden shadow-inner">
                <motion.div 
                  className="h-full bg-gradient-to-r from-neha-500 to-neha-600 rounded-full shadow-sm"
                  initial={{ scaleX: 0 }}
        ...
        >
          <div className="glass rounded-2xl p-5 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-neha-100/50">
            <h3 className="text-xl sm:text-2xl font-semibold mb-6 bg-gradient-to-r from-neha-700 to-neha-600 bg-clip-text text-transparent">Areas of Specialization</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              ...
              >
                <div className="rounded-xl bg-gradient-to-br from-neha-100 to-neha-50 p-2 sm:p-3 text-neha-700 ring-2 ring-neha-200 shadow-sm">
